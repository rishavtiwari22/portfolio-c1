        ...
        <div className="flex items-center justify-between px-4 md:px-8 xl:px-12">
          ...
          <div className="flex items-center group">
            <div className="relative">
              ...
              <span className="relative bg-gradient-to-br from-orange-500 to-red-500 text-white font-bold rounded-full h-12 w-12 flex items-center justify-center shadow-lg transform group-hover:rotate-12 transition-all duration-300">RT</span>
            </div>
            <div className="ml-3">
