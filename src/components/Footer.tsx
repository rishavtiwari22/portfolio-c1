        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-4 md:px-8 xl:px-12">
          <div className="md:col-span-1">
            ...
            <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-xl p-4 mb-6 shadow-[0_8px_30px_rgba(0,0,0,0.12)]">
              ...
              A passionate MERN Stack Developer 2+ Year in Educational Innovation and Technology.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 w-full">
              {/* GitHub */}
              <a
                href="https://github.com/rishavtiwari22"
                target="_blank"
              ...
              {/* LinkedIn */}
              <a
                href="www.linkedin.com/in/rishavtiwari22"
                target="_blank"
                rel="noopener noreferrer"
                className="group glassmorphic-light bg-white/10 text-gray-300 transition-all duration-300 
                        w-10 h-10 rounded-xl flex items-center justify-center
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/rishavtiwari_arya/profilecard/?igsh=MTRiZjFnenc4NjZ4eQ=="
                target="_blank"
                rel="noopener noreferrer"
                className="group glassmorphic-light bg-white/10 text-gray-300 transition-all duration-300 
                        w-10 h-10 rounded-xl flex items-center justify-center
          ...
          <div className="backdrop-blur-sm bg-white/10 border border-white/20 rounded-xl p-5 shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(255,140,0,0.1)] transition-all duration-500">
            ...
            <ul className="space-y-3">
              {['Web Development', 'UI/UX Design', 'Branding', 'Consulting'].map((item) => (
                <li key={item}>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3 group">
                ...
                <div className="flex-1">
                  ...
                  <a href="mailto:info@example.com" className="text-gray-300 hover:text-orange-400 transition-all duration-300">tiwaririshav463@gmail.com</a>
                </div>
              </li>
              <li className="flex items-start space-x-3 group">
                <div className="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center mt-0.5 
                ...
                <div className="flex-1">
                  ...
                  <a href="tel:+911234567890" className="text-gray-400 hover:text-orange-300 transition-all duration-300">+91 9336648747</a>
                </div>
              </li>
              <li className="flex items-start space-x-3 group">
                <div className="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center mt-0.5 
